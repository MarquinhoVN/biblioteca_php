			...
			<div class="container d-flex">
				<div class="flex-grow-1 d-flex justify-content-center">
					<ul class="w-100 nav nav-pills">
						...
						<li class="nav-item">
							<a class="nav-link active" href="cadastro_livro.php">Cadastro de Livros</a>
						</li>
						<li class="nav-item">
					...
					<div class="container pagina">
						<div class="row">
							<div class="col">
								...
								<form method="post" action="controller.php?acao=inserir&&controller=livro">
									<div class="form-group">
										<label>Nome:</label>
										<input type="text" name="nome" class="form-control" placeholder="Exemplo: Diário de um Banana">
                                        <br>
                                        <label>Autor:</label>
										<input type="text" name="autor" class="form-control" placeholder="Exemplo: Jeff Kinney">
										<br>
										<label>Ano:</label>
										<input type="text" name="ano" class="form-control" placeholder="Exemplo: 2008">
									</div>
