					...
					<div class="container pagina">
						<div class="row">
							<div class="col">
								...
								<form method="post" action="controller.php?acao=inserir&&controller=aluno">
									<div class="form-group">
										<label>Nome:</label>
										<input type="text" name="nome" class="form-control" placeholder="Exemplo: Fernando">
                                        <br>
                                        <label>Matricula:</label>
										<input type="text" name="matricula" class="form-control" placeholder="Exemplo: 2021000544">
									</div>
